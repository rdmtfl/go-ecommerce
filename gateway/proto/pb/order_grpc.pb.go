...
type OrderServiceClient interface {
	PostOrder(ctx context.Context, in *OrderRequest, opts ...grpc.CallOption) (*OrderResponse, error)
}
...
func (c *orderServiceClient) PostOrder(ctx context.Context, in *OrderRequest, opts ...grpc.CallOption) (*OrderResponse, error) {
...
type OrderServiceServer interface {
	PostOrder(context.Context, *OrderRequest) (*OrderResponse, error)
...
func (UnimplementedOrderServiceServer) PostOrder(context.Context, *OrderRequest) (*OrderResponse, error) {
...
func _OrderService_PostOrder_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(OrderServiceServer).PostOrder(ctx, req.(*OrderRequest))
	}
